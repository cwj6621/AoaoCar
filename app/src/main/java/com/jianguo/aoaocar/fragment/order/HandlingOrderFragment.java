...
import com.it.jianguo.common.commonutils.LogUtils;
...
public class HandlingOrderFragment extends BaseFragment {
    ...
    private void initData() {
        ...
        mOrder.setmOrderState(Order.OrderState.NOT_COMPLETE);
