...
public class CrilcleRecordView extends View {

    private final String TAG = "CrilcleRecordView";
    ...
    public CrilcleRecordView(Context context) {
        this(context, null);
    }

    public CrilcleRecordView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public CrilcleRecordView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mRingWidth = a.getFloat(R.styleable.SuperCircleView_ring_width, 10);

        mSelect = a.getInteger(R.styleable.SuperCircleView_select, 1);
        mSelectAngle = a.getInteger(R.styleable.SuperCircleView_selec_angle, 1);

        mMinCircleColor = a.getColor(R.styleable.SuperCircleView_circle_color, context.getResources().getColor(R.color.white));
        mMaxCircleColor = a.getColor(R.styleable.SuperCircleView_max_circle_color, context.getResources().getColor(R.color.toast_stroke_gray));
        mRingNormalColor = a.getColor(R.styleable.SuperCircleView_ring_normal_color, context.getResources().getColor(R.color.colorLimePrimary));
        ...
        color[1] = Color.parseColor("#8EE484");
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawCircle(mViewCenterX, mViewCenterY, mMinRadio + mRingWidth + 15, mPaint);
