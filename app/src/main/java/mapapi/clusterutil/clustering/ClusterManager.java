...
public class ClusterManager<T extends ClusterItem> implements
    ...
    private OnClusterMapStatusChangeListener  mOnClusterMapStatusChangeListener;
    ...
    public void onMapStatusChangeStart(MapStatus mapStatus) {
        if(mOnClusterMapStatusChangeListener!=null) {
            mOnClusterMapStatusChangeListener.onMapStatusChange(mapStatus, true);
        }
    }
    ...
    public void onMapStatusChangeFinish(MapStatus mapStatus) {
        if(mOnClusterMapStatusChangeListener!=null) {
            mOnClusterMapStatusChangeListener.onMapStatusChange(mapStatus, false);
        }
    }
    ...
    public void seOnClusterMapStatusChangeListener(OnClusterMapStatusChangeListener  listener) {
        mOnClusterMapStatusChangeListener = listener;
    ...
    public   interface  OnClusterMapStatusChangeListener{
