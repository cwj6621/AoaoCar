package com.jianguo.aoaocar.view.silderbottompannel;
...
//                }
    ...
    public void hidePanel() {
        ...
        if(mExternalView!=null&&isPanelShowing()){
            startAnima(offY);
        }
    ...
    public void setExternalView(LinearLayout view,int _offY) {
         this.mExternalView=view;
         this.offY=_offY;
         startAnima(_offY);
    }

    public void startAnima(int offy) {
        android.animation.ObjectAnimator translate1 = android.animation.ObjectAnimator.ofFloat(mExternalView, "translationY",  dp2px(offy));
        //  AnimatorSet set = new AnimatorSet();
        //set.playTogether(translate, translate1);
        translate1.setDuration(150);
        translate1.start();
    }
}
