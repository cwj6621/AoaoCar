...
public class DriverHostCarActivity extends BaseActivity{
     ...
     setTitle("认购");
        ...
        spinnerview.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                SpinnerItemPop spinnerItemPop= new SpinnerItemPop(DriverHostCarActivity.this,list,0, new SpinnerItemPop.OnDismissListListener() {
                    @Override
        ...
        btnBuyCar.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
              //  Utils.toActivity(DriverHostCarActivity.this,SendCarActivity.class);
            }
        });
    }
}
